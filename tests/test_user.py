...
def test_create_user_with_valid_email():
    ...
    new_user = {"name": "Anna", "email": "anna@mail.com"}
...
def test_create_user_with_invalid_email():
    ...
    existing_user = {"name": "Antony", "email": users[0]['email']}
